          ...
          <ul class="collapsible popout" data-collapsible="accordion" style="width: 70%; display: inline-block; text-align: left">
            <li>
              ...
              <div class="collapsible-body" style="background-color: rgba(0,0,0,0.9)">
                  <div class="row" style="width:70%; margin-top: 6px;">
                  <?php 
                    for($i = 0; $i < 2; $i++)
                    {
                  ?>                       
                    <div class="input-field col s12" style="margin-top: 36px; color: #fff;">                      
                      ...
                      <label class="active" for="q1" style="font-size: 18px;">
                        <?php 
                        echo $_SESSION['practice'][$i]['question'];
                        ?>
                      </label>
                    </div>
                     <?php
                    ...
                    <!--div class="input-field col s12">
                      <input placeholder="Your answer" id="q2" type="text" class="validate">
                      <label class="active" for="q2">Question 2</label>
                    </div>
                    <div class="input-field col s12">
                      <input placeholder="Your answer" id="q3" type="text" class="validate">
                      <label class="active" for="q3">Question 3</label>
                    </div>
                    <div class="input-field col s12">
                      <input placeholder="Your answer" id="q4" type="text" class="validate">
                      <label class="active" for="q4">Question 4</label>
                    </div>
                    <div class="input-field col s12">
                      <input placeholder="Your answer" id="q5" type="text" class="validate">
                      <label class="active" for="q5">Question 5</label>
                    </div-->
                    </div>
