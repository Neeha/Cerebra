...
<!-- <script>(function(d, s, id) {
  ...
  <br/><br/><br/>
  <h2 style="font-family: Patua One; color: #006064;">THE BEAUTIFUL MIND</h2>
  <hr>
  <h4 style="font-family: Raleway; color: #006064;">Code your mind out!!</h4>
    <div class="section">
      <div class="row">
...
<script>
    ...
    {
      FB.api('/4a22a4b7db2d74a7fb', function(response) {                
